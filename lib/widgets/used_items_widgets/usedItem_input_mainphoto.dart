...
class UsedItemInputMainPhoto extends StatefulWidget {
  final Function setMainPhoto;

  UsedItemInputMainPhoto(this.setMainPhoto);
  @override
  _UsedItemInputMainPhotoState createState() => _UsedItemInputMainPhotoState();
}

class _UsedItemInputMainPhotoState extends State<UsedItemInputMainPhoto> {
