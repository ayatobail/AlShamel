...
class UsedItemImagesInput extends StatefulWidget {
  @override
  _UsedItemImagesInputState createState() => _UsedItemImagesInputState();
}

class _UsedItemImagesInputState extends State<UsedItemImagesInput> {
  late List<File> imgsFiles;
