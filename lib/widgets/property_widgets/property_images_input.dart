...
class PropertyImagesInput extends StatefulWidget {
  @override
  _PropertyImagesInputState createState() => _PropertyImagesInputState();
}

class _PropertyImagesInputState extends State<PropertyImagesInput> {
  List<File>? imgsFiles;
  void _selectImages() async {
    imgsFiles =
        Provider.of<PropertyItem>(context, listen: false).getimgsForUpload;
                        ...
                        return AlertDialog(
                          ...
                          actions: <Widget>[
                            ...
                            TextButton(
                              ...
                              onPressed: () => setState(() {
                                Provider.of<PropertyItem>(context,
                                        listen: false)
                                    .getimgsForUpload
                                    .removeAt(index);
